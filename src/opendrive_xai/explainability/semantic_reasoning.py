...
__all__ = ["SemanticNavigationReasoner", "NavigationQuery", "ASPRule", "ExplanationResult"]
...
class SemanticNavigationReasoner:
    ...
    def __init__(self):
        ...
        logger.info("Semantic Navigation Reasoner initialized with explainable AI capabilities")
    ...
    def generate_asp_rules_from_instruction(self, instruction: str) -> List[ASPRule]:
        ...
        logger.info(f"Generated {len(generated_rules)} ASP rules from instruction: '{instruction}'")
